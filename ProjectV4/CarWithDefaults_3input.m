...
classdef CarWithDefaults_3input < Car
    methods
        function obj = CarWithDefaults_3input(type)
            arguments
    ...
    methods (Access=private)
        function obj = setSedanDefaults(obj)
            ...
            obj.dynamics.F_z1_static = 250;
            obj.dynamics.F_z2_static = 250;
            obj.dynamics.F_z3_static = 250;
            obj.dynamics.F_z4_static = 250;
            ...
            obj.limits.Input.Lowerbound = -[obj.limits.Input.Torque; obj.limits.Input.Torque; obj.limits.Input.delta];
            obj.limits.Input.Upperbound = [obj.limits.Input.Torque; obj.limits.Input.Torque; obj.limits.Input.delta];
