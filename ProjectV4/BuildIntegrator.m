...
% xNextFull = Function('xNextFull', {x_k, u_k, z_0}, {result.xf, result.zf}); %returns final x_k+1 (Ts later) from integration result
...
% Delta=Ts*5
solver = mpc.nmpc('f',xNext_mp,'N',N,'l',l,'x0',x0,'verbosity','0','guess',guess);
