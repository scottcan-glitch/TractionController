classdef Limits < handle
    ...
    methods
        function obj = Limits()
            ...
            obj.Input.delta_dot  = sym('delta_dot', 'real');
            ...
            obj.Input.Lowerbound = -[obj.Input.Torque; obj.Input.Torque; obj.Input.delta; obj.Input.delta_dot];
            obj.Input.Upperbound = [obj.Input.Torque; obj.Input.Torque; obj.Input.delta; obj.Input.delta_dot];
