function f_op = evaluateAtOp(f, x_op, u_op)
% evaluateAtOp  Evaluate symbolic model f at a given operating point
%   u_op includes delta_dot concatinated on the end
%
...
%   u_op  : (optional) numeric or symbolic 4x1 (or 1x4) vector [T_m2; T_m3; delta; delta_dot]
    ...
    x = sym({'v_x','v_y','r','omega_2','omega_3'});  % 1x5 sym
    u = sym({'T_m2','T_m3','delta','delta_dot'});    % 1x4 sym
