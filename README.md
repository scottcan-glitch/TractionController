...
ProjectV4 contains ME675 Course Project, Nonlinear MPC Traction controller. Some notes:
  ...
  - Good luck
      ...
      - The 5th order DAE is converter to CasADi symbolic variables, so that the CasADi implementation of the IDAS solver can be used for iterative optimization. This is done by BuildIntegrator.m, and MPC formulation is done by BuildMPC.m
      - /WorkSpace contains some simulation results
      - This read me is getting too long, message me if you want more detail. some filenames are named ECE675 which is a typo. course was ME675, oopsy
