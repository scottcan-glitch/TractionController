function [x, x_dot, u, u_dot, P] = makeSymbols()
% %   Creates a struct of symbolic parameters, states + state vector, &
% %   input + input vector with dot-access.
%   P.<parametername>
%   x.<IndividualState>
%   x.vector
%   u.<IndividualInput>
%   u.vector
    ...
    geometry = {'wc_1_x','wc_1_y','wc_2_x','wc_2_y','wc_3_x','wc_3_y','wc_4_x','wc_4_y', ...
        'a','b','h','t','r_wheel', 'A_frontal','A_side','C_drag'};
    dynamics = {'lambda_front','I_1','I_2','I_3','I_4','B_1','B_2','B_3', ...
        'B_4', 'I_zz','m_vehicle','rho_air','F_z1_static','F_z2_static','F_z3_static' ...
        'F_z4_static'};
    ...
    paramNames = {
        ...
        'omega_1','omega_4','omega_dot_1','omega_dot_4', ...
        'lambda_1','lambda_2','lambda_3','lambda_4', ...
        'alpha_1','alpha_2','alpha_3','alpha_4', ...
        'F_1_x','F_1_y','F_2_x','F_2_y','F_3_x','F_3_y','F_4_x','F_4_y','F_x','F_y','M_z', ...
        'F_drag_x','F_drag_y'...
        'F_z1','F_z2','F_z3','F_z4'...
    ...
    % Combine all params, ensure no duplicates, consistent order
        paramNames = [pacejka, geometry, dynamics, paramNames];
        [~, ia] = unique(paramNames, 'stable');
    paramNames = paramNames(sort(ia));    % ordered unique names
    ...
    % % Parameter Struct
    % P.m_vehicle, P.b, ... for individual access
    P = struct();
    for i = 1:numel(paramNames)
        name = paramNames{i};
        % create a symbolic variable and store it as a field (real assumption)
        P.(name) = sym(name, 'real');  
    end
