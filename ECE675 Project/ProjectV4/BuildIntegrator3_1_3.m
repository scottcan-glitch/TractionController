...
%% Build LOW-MU model with sedan2 Car.m instance, sets up CasADi integrator for
% % state evolution. xNext() integrates to next state.

sedan2 = CarWithDefaults_3input("sedan");
sedan2.pacejka.long.mu = [0.2; 0.2; 0.9; 0.9];
sedan2.pacejka.lat.mu = [0.2; 0.2; 0.9; 0.9];
...
Nh = 10;
% MPC solver 
solveMPC = makeMPCSolver3(xNext, Nh, sedan1);
...
% Initial Condition
x0_val = [28;0;0;28/sedan1.geometry.r_wheel;28/sedan1.geometry.r_wheel]; %skip to loop 140
...
for k = 1:Nsim
    ...
    elseif k >= (15)
        ...
        solverMPC = makeMPCSolver3(xNext2,Nh,sedan2); % we assume all states observed, OCP uses the correct slip
    end
